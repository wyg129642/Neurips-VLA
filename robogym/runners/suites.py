...
class SyntheticSuite:
    """Stand-in for a LIBERO suite running on the synthetic backend."""
...
class LiberoSuite:
    """Real LIBERO task provider (reads the HDF5 expert demos)."""
...
class ReasoningRunnerSuite:
    """Adapt the System-2 reasoning suite to the runner's provider API."""
